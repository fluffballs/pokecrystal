...
; Johto story events
	...
	const EVENT_GOT_MISDREAVUS_FROM_ELM
	const EVENT_GOT_SNEASEL_FROM_ELM
	const EVENT_GOT_GLIGAR_FROM_ELM
...
; Johto itemballs
	const EVENT_MISDREAVUS_POKEBALL_IN_ELMS_LAB
	const EVENT_SNEASEL_POKEBALL_IN_ELMS_LAB
	const EVENT_GLIGAR_POKEBALL_IN_ELMS_LAB
