...
SneaselPokeBallScript:
	...
	closepokepic
	opentext
	writetext TakeSneaselText
	yesorno
	iffalse DidntChooseStarterScript
	disappear ELMSLAB_POKE_BALL2
	setevent EVENT_GOT_SNEASEL_FROM_ELM
	writetext ChoseStarterText
	promptbutton
	waitsfx
	...
	closetext
	applymovement PLAYER, AfterSneaselMovement
	sjump ElmDirectionsScript

GligarPokeBallScript:
	checkevent EVENT_GOT_A_POKEMON_FROM_ELM
	iftrue LookAtElmPokeBallScript
	turnobject ELMSLAB_ELM, DOWN
	reanchormap
	...
	closepokepic
	opentext
	writetext TakeGligarText
	yesorno
	iffalse DidntChooseStarterScript
	disappear ELMSLAB_POKE_BALL3
	setevent EVENT_GOT_GLIGAR_FROM_ELM
	writetext ChoseStarterText
	promptbutton
	waitsfx
	...
	waitsfx
	promptbutton
	givepoke GLIGAR, 5, BERRY
	closetext
	applymovement PLAYER, AfterGligarMovement
	sjump ElmDirectionsScript
...
ElmsLab_MapEvents:
	...
	object_event  7,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SneaselPokeBallScript, EVENT_SNEASEL_POKEBALL_IN_ELMS_LAB
	object_event  8,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GligarPokeBallScript, EVENT_GLIGAR_POKEBALL_IN_ELMS_LAB
